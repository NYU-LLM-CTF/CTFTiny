...
CTFTiny follows the same benchmark structure as NYU CTF Bench. Please refer to [NYU CTF Bench](https://github.com/NYU-LLM-CTF/NYU_CTF_Bench) for detailed usage.
